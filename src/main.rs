...
fn artists_init() -> Vec<Artist> {
    ...
    */
    ...
    record_dates: String::from("1979"), description: String::from("Nice cover")}]});
    ...
    description: String::from("Very cool thanks mr hayes i like long songs")}]});
    return artists;
}
...
fn albums_init() -> Vec<Album> {
    ...
    */
    ...
    artist: String::from("Miles Davis"), format: String::from("LP"), release_year: 1960, 
    record_dates: String::from("1959"), description: String::from("The one after Kind of Blue")});
    ...
    description: String::from("The last KC record :(")});

    albums.push(Album { name: String::from("Hot Buttered Soul"), genre:  String::from("Progressive Soul"), 
    artist: String::from("Isaac Hayes"), format: String::from("LP"), release_year: 1969, record_dates: String::from("End of the sixties"), 
    description: String::from("Very cool thanks mr hayes i like long songs")});

    albums.push(Album { name: String::from("Unknown Pleasures"), genre:  String::from("Post-Punk"), artist: 
    String::from("Joy Division"), format: String::from("LP"), release_year: 1979, record_dates: String::from("End of the seventies"), 
    description: String::from("Nice cover")});
